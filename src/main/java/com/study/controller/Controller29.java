...
public class Controller29 {
    ...
    public String method2(Integer id, RedirectAttributes rttr) throws SQLException {
        ...
        if (rowCount > 0) {
            ...
            rttr.addFlashAttribute("message", id + "번 고객이 삭제 되지 않았습니다!");
        }
    ...
    @PostMapping("sub2")
    public String method4(@RequestParam Integer id, RedirectAttributes rttr) throws SQLException {
        if (id != null) {
            String sql = """
            ...
            if (rowCount > 0) {
                ...
                rttr.addFlashAttribute("message", id + "번 직원이 삭제 되지 않았습니다!");
            }
        }
